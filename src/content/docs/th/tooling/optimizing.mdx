...
> 💡 ตัวอย่างจากของจริง
>
> **Emscripten** เรียก `wasm-opt` ของ Binaryen ให้อัตโนมัติเมื่อ build ด้วย `-O2`/`-O3` อยู่แล้ว ([เอกสาร Emscripten](https://emscripten.org/docs/optimizing/Optimizing-Code.html)) — playbook ทั้งห้าขั้นตอนในบทนี้คือสิ่งที่ต้องรันเองใน CI สำหรับ toolchain ที่ไม่ได้ทำให้อัตโนมัติแบบนั้น หรือตอน optimize WAT ที่เขียนมือ/binary จากบุคคลที่สาม
