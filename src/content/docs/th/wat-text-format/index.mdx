...
WAT คือรูปแบบข้อความที่อ่านได้ของ binary format `.wasm` เหมาะมากสำหรับการเรียนรู้แบบจำลองการเอ็กซิคิวต์ของ Wasm ในงาน production คุณแทบจะคอมไพล์จากภาษาระดับสูงกว่าเสมอ
</Callout>
