...
> 💡 ตัวอย่างจากของจริง
>
> [FFmpeg.wasm](https://github.com/ffmpegwasm/ffmpeg.wasm) ส่ง filename และ metadata string ผ่านรูปแบบ (ptr, len) เดียวกันนี้ข้าม linear memory เพื่อสั่งงาน decoder ที่คอมไพล์มาจาก C โดยไม่ต้องแปลง string ผ่าน glue code ที่ช้าลง
