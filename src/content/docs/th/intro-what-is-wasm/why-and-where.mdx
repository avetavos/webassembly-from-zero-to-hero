...
> 💡 ตัวอย่างจากของจริง
>
> Adobe ใช้ WebAssembly พอร์ต Photoshop C++ codebase ทั้งก้อนมารันใน browser เป็น Photoshop บนเว็บ โดยยังคง algorithm การประมวลผลภาพเดิมไว้ทั้งหมด ([web.dev case study](https://web.dev/ps-on-the-web/))
