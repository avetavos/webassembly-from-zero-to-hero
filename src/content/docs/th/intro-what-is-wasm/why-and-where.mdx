...
บ้านหลักของ Wasm คือ browser ผ่าน WebAssembly JavaScript API หน้าเว็บโหลดไฟล์ `.wasm` binary, instantiate มันด้วย `WebAssembly.instantiate` และเรียกฟังก์ชันที่ export มาโดยตรงจาก JavaScript
...
- เห็นว่า Wasm "เร็วกว่า native เกือบเท่า" แล้วสรุปว่ามันเร็วกว่า JavaScript เสมอในทุก workload ทั้งที่ JS engine สมัยใหม่ optimize hot loop ได้ดีมากเช่นกัน
