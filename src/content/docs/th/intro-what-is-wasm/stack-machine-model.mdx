...
> 💡 ตัวอย่างจากของจริง
>
> Figma เขียน rendering engine ใหม่จาก C++ เป็น Wasm และวัดผลได้ว่าเวลาโหลดไฟล์เร็วขึ้น **มากกว่า 3 เท่า** ในทุกขนาดเอกสาร ส่วนหนึ่งเป็นเพราะ Wasm module ถูก validate เป็น stack-based bytecode แล้วคอมไพล์เป็น native code ได้เกือบทันที ([Figma engineering blog](https://www.figma.com/blog/webassembly-cut-figmas-load-time-by-3x/))
