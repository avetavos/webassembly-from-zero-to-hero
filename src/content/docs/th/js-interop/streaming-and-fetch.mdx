...
> 💡 ตัวอย่างจากของจริง
>
> [Squoosh](https://github.com/GoogleChromeLabs/squoosh) ใช้ `instantiateStreaming` โหลด codec แต่ละตัวเพื่อให้ startup เร็วที่สุด

export const quizStreamingAndFetch = [
  { q: "เหตุใด instantiateStreaming จึงเหมาะสมกว่า instantiate สำหรับ production?", options: ["ข้ามขั้นตอนการตรวจสอบ", "คอมไพล์ไปพร้อมกับที่ bytes stream เข้ามา ลด latency", "ทำงานได้โดยไม่ต้องมี server", "รองรับ Wasm features มากกว่า"], answer: 1 },
